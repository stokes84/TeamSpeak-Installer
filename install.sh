...
if [[ ${architecture} == "x86_64" ]]; then
	...
	wget --tries=5 --progress=bar:force http://dl.4players.de/ts/releases/3.0.12.4/teamspeak3-server_linux_amd64-3.0.12.4.tar.bz2 -O teamspeak3-64.tar.bz2 2>&1 | wget_filter
	...
	wget --tries=5 --progress=bar:force http://dl.4players.de/ts/releases/3.0.12.4/teamspeak3-server_linux_x86-3.0.12.4.tar.bz2 -O teamspeak3-32.tar.bz2 2>&1 | wget_filter
